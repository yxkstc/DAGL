...
public class Batchimport extends JPanel {
    ...
    private void UploadingfilesActionPerformed(ActionEvent e) throws IOException {
        ...
        if(textField1.getText().length()>0){
            filesTable.setModel( GuiVerification.queryTableModel(excelImport.readExcel(textField1.getText())));
        }else {
            return;
        }
    }
        ...
        try {
            if (filesTable.getRowCount()>0){
                ...
                for (int i=0;i<rowCount;i++){
                    ...
                    dm.setTitle(filesTable.getValueAt(i,3));
    ...
    public JPanel initComponents() {
        ...
        ((GridBagLayout)jp.getLayout()).columnWidths =  new int[] {112, 0, 0};
        ((GridBagLayout)jp.getLayout()).rowHeights =  new int[] {41, 38, 0, 0};
        ((GridBagLayout)jp.getLayout()).columnWeights = new double[] {0.0, 1.0, 1.0E-4};
        ((GridBagLayout)jp.getLayout()).rowWeights = new double[] {0.0, 0.0, 1.0, 1.0E-4};
        ...
        jp.add(Uploadingfiles, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 5), 0, 0));

        jp.add(textField1, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
        ...
        jp.add(Save, new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 5, 0), 0, 0));

        scrollPane1.setViewportView(filesTable);
        jp.add(scrollPane1, new GridBagConstraints(0, 2, 2, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(0, 0, 0, 0), 0, 0));
        
        // JFormDesigner - End of component initialization  //GEN-END:initComponents
        jp.setName("EXECL批量导入");
        return jp;
    }
